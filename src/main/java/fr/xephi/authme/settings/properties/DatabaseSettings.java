...
public final class DatabaseSettings implements SettingsHolder {
    ...
    public static final Property<String> MONGODB_CONNECTION_URI =
        newProperty("DataSource.mongodb.uri", "mongodb://mongodb0.example.com:27017");

    @Comment({"MongoDB Premium Auth Collection"})
    public static final Property<String> MONGODB_COLLECTION =
        newProperty("DataSource.mongodb.collection", "Premium-Auth");
